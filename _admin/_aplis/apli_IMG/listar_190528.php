	...
	<div class="card">
        <div class='card-header'>
            <div style="float:left">		
                    <button class='btn btn-admin btn-sm' onclick="window.location.href='index.php?editar=1&id_apli_img=<? echo $rowp[$countrow]['id_apli_img'] ?>&id_apli=<? echo $rowp[$countrow]['id_apli'] ?>&apli_padre=<? echo $_GET['apli_padre'] ?>'">EDITAR</button>
            ...
            <div style="float:right">
				<? if($row_destacado['destacado_img'] == $rowp[$countrow]['id_apli_img']){ $checked = 'checked="checked"'; $flag = ''; } else { $checked = ''; $flag = '1'; }  ?>
                <input <? echo $checked; ?> title='Imagen destacada' type='checkbox' class='chk star' onclick="javascript:recibeid('destacado.php', 'id_apli_img=<? echo $rowp[$countrow]['id_apli_img']; ?>&id_apli=<? echo $rowp[$countrow]['id_apli']; ?>&apli_padre=<? echo $_GET['apli_padre']; ?>&flag=<? echo $flag; ?>', '', 'div_null')" /><div id='div_null'></div>
            </div>
