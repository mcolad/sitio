<?PHP 
	...
	else
	{
        ...
        <div class='col-md-12 text-right mt-3'>
             <button class='btn btn-success btn-sm' onclick="window.location.href='index.php?csv=1&editar=1&id_apli_tagdetag=<? echo $_GET['id_apli_tagdetag'] ?>'" type="submit"/>Subir CSV</button>
        </div>
		<?
	}
?>
