...
?>
	...
	<div class="card">
        <div class='card-header '>
                <div class="row">
                    <div class='col-auto'>		
                            <button class='btn btn-success btn-sm' onclick="window.location.href='?editar=1&play=<? echo $play; ?>&order_que=<? echo $order_que ?>&order=<? echo $order ?>&filtro_tag=<? echo $filtro_tag; ?>&id=<? echo $rowp[$countrow]["id_apli_".strtolower($apli)] ?>'">EDITAR</button>
